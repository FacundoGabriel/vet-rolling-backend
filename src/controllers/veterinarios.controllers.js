const { obtenerVeterinariosBD, aprobarVeterinarioBD, registrarVeterinarioBD } = require("../services/veterinarios.services")
...
const aprobarVeterinario = async(req, res) => {
    const {msg, statusCode, error} = await aprobarVeterinarioBD(req.params.idUsuario)
    try {
